...
const BooksSingleCard = ({book}) => {
    return (
        <div
            key={book._id}
            className='border-2 border-gray-500 bg-blue-300 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl'
        >
            <h2 className='absolute top-1 right-2 px-4 py-1 bg-gray-300 text-black rounded-lg'>
                {book.publishYear}
            </h2>
